...
export type ProductFilterParameter = {
  ...
  description?: Maybe<StringOperators>,
  legacy_itemId?: Maybe<NumberOperators>,
...
export type ProductVariantFilterParameter = {
  ...
  legacy_prodId?: Maybe<NumberOperators>,
...
export type UpdateReviewMutation = (
  { __typename?: 'Mutation' }
  & { updateProductReview: { __typename?: 'ProductReview' }
    & ProductReviewFragment
   }
);
...
export type GetReviewForProductQuery = (
  ...
  & { product: Maybe<(
    ...
    & { reviews: (
      { __typename?: 'ProductReviewList' }
      & Pick<ProductReviewList, 'totalItems'>
      & { items: Array<{ __typename?: 'ProductReview' }
        & ProductReviewFragment
      > }
    ) }
  )> }
